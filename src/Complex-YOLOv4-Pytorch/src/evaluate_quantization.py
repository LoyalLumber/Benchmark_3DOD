...
def evaluate_mAP(val_loader, model, configs, logger):
    ...
    return precision, recall, AP, f1, ap_class#, FPS, CPU, GPU, RAM, CPU_cur, GPU_cur, CPU_usg, GPU_usg
...
def parse_eval_configs():
    ...
    parser.add_argument('--cfgfile', type=str, default='./config/cfg/complex_yolov3.cfg', metavar='PATH',
                        help='The path for cfgfile (only for darknet)')
    parser.add_argument('--pretrained_path', type=str, default='../checkpoints/complex_YOLOv3/complex_yolov3.pth', metavar='PATH',
                        help='the path of the pretrained checkpoint')
    parser.add_argument('--use_giou_loss', action='store_true',
                        help='If true, use GIoU loss during training. If false, use MSE loss for training')

    #parser.add_argument('--no_cuda', action='store_true',
    parser.add_argument('--no_cuda', default=1,
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(configs.pretrained_path, map_location='cpu')) #CJ - for the quantization
    ...
    #210831 CJ - add the function for Quantization below!
    ...
    print("\nStart computing mAP...\n")
    precision, recall, AP, f1, ap_class = evaluate_mAP(val_dataloader, quantized_model, configs, None)
